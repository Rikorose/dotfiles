...
handle_file_ln "$HOME/.dotfiles/bash_completion" "$HOME/.bash_completion"
handle_file_ln "$HOME/.dotfiles/bash_completion.d/setup_git.bash" "$HOME/.bash_completion.d/setup_git.bash"
handle_file_ln "$HOME/.dotfiles/bash_completion.d/setup_mpv.bash" "$HOME/.bash_completion.d/setup_mpv.bash"
handle_file_ln "$HOME/.dotfiles/bash_completion.d/vman.bash" "$HOME/.bash_completion.d/vman.bash"
...
handle_file_ln "$HOME/.dotfiles/config/nvim/lib/languages/man.vim" "$HOME/.config/nvim/lib/languages/man.vim"
...
handle_file_ln "$HOME/.dotfiles/local/bin/json_update_value" "$HOME/.local/bin/json_update_value"
...
handle_file_ln "$HOME/.dotfiles/local/bin/vman" "$HOME/.local/bin/vman"
